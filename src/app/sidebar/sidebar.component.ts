...
export let ROUTES: RouteInfo[] = [
    { path: 'dashboard', title: 'Dashboard',  icon: 'ti-home', role1: 'administrator', role2: 'regular' },
    { path: 'bo/H69', title: 'Business Object',  icon:'ti-server', role1: 'administrator', role2: 'regular' },
    { path: 'actions', title: 'Actions',  icon:'ti-panel', role1: 'administrator', role2: 'regular' },
...
export class SidebarComponent implements OnInit {
    ...
    auth(): void {
        ...
        this.menuItems.push({ path: 'desktop', title: 'Desktop Application',  icon:'ti-desktop', role1: 'administrator', role2: 'regular' });
    }
}
